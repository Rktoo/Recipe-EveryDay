...
export default function Home() {
    ...
    return (
        <div >
            <div className="container-recipe flex flex-col gap-2 mb-10 px-4 py-2 border-[1px] border-white backdrop-blur-md rounded-xl ">
            ...
            <div className="flex flex-col md:flex-row md:justify-center gap-2 ">
                {
                    subCategories && subCategories.map(sub => (
                        <div className="container-recipe w-[300px] flex flex-col justify-end items-end px-4 py-2 border-[1px] border-white backdrop-blur-md rounded-xl " key={sub.titre}>
